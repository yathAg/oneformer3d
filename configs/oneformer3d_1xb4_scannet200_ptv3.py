...
model = dict(
    type='ScanNet200OneFormer3DPTv3',
    ...
    backbone=dict(
        ...
        dec_channels=(ptv3_out_channels, 64, 128, 256),
...
load_from = '<path/to/ptv3_pretrained_model.pth>'

train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=512, val_interval=16)
val_cfg = dict(type='ValLoop')
test_cfg = dict(type='TestLoop')

work_dir = 'work_dirs/oneformer3d_1xb4_scannet200_ptv3'
